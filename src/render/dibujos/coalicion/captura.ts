...
export function dibujar(contenedor: Phaser.GameObjects.Container, escena: Phaser.Scene): void {
  ...
  g.fillRoundedRect(-cuerpoLargo / 2, -cuerpoAncho / 2, cuerpoLargo, cuerpoAncho, largo * 0.14);
  g.strokeRoundedRect(-cuerpoLargo / 2, -cuerpoAncho / 2, cuerpoLargo, cuerpoAncho, largo * 0.14);
